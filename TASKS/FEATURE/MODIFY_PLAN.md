...
2.  **Existing Implementation Plan:** Read the implementation plan that needs to be updated at `PLANS/<feature_name>_PLAN.md`.
...
1.  **Modify Tasks:** Edit `PLANS/<feature_name>_PLAN.md` to reflect the identified changes.
...
3.  **Log the Change:** Add a changelog entry at the bottom of `PLANS/<feature_name>_PLAN.md` to record that the plan was modified to align with an updated feature description, including the date.
